...
const Header = () => {
  ...
  const [options, setOptions] = useState([
    { label: "All Categories", value: "0", slug: "#" },
  ]);
    ...
    fetch("/api/categories")
      ...
      .then((data) => {
        const mapped = data.map((item) => ({
          label: item.name,
          value: item.id, // ✅ correct key
          slug: item.slug,
        }));
        setOptions([...mapped, { label: "All Categories", value: "0" }]);
      });
  }, []);
  const handleSearch = (e: React.FormEvent) => {
    ...
    router.push(`/ai-glasses?q=${encodeURIComponent(searchQuery.trim())}`);
  };
            ...
            <div className="max-w-[475px] w-full">
              <form onSubmit={handleSearch}>
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[666px] sm:min-w-[666px] w-full">
                    {/* <!-- divider --> */}
                    <input
